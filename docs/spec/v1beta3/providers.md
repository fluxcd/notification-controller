...
**Note:** The `address` field is optional for Telegram providers. If not specified,
the controller will use the default Telegram Bot API endpoint (`https://api.telegram.org`).
