...
<td>
<em>(Optional)</em>
<p>EventMetadata is an optional field for adding metadata to events dispatched
...
example, the &ldquo;summary&rdquo; field when present in the Alert spec), and these will
have priority over everything else.</p>
</td>
</tr>
<tr>
<td>
